...
const EventCard = ({ event, hasOrderLink, hidePrice }: EventCardProps) => {
  ...
  return (
    <div className="group relative flex min-h-[380px] w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-white shadow-md transtion-all hover:shadow-lg md:min-h-[438px]">
      <Link
